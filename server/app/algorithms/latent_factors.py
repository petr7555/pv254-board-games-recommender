...
def get_latent_factors_recommendations(games: dict[str, Game], ratings, items_factors, user_id=None):
    ...
    recommended_games_ids = predicted_ratings.sort_values("predicted_rating", ascending=False).index.array
    sorted_games = [games[str(game_id)] for game_id in recommended_games_ids]
    return sorted_games
